...
export function getEntityText(entity) {
    ...
    if (entity.textBytes) {
        ...
        else if ((Array.isArray(entity.textBytes) || entity.textBytes instanceof Uint8Array) && entity.textBytes.length > 0) {
...
export function processTextData(textData) {
    ...
    if (textData.textBytes && textData.textBytes.size && textData.textBytes.size() > 0) {
